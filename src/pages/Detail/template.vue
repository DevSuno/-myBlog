<template>
  <div id="detail">
    <section class="user-info">
      <img alt="" class="avatar" src="http://cn.gravatar.com/avatar/1?s=128&d=identicon">
      <h3>前端异步大揭秘</h3>
      <p>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      ...
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/48497835.jpg"></p>
      <h3 id="grid-track">Grid Track</h3>
      <p>两个相邻网格线之间的空间。 你可以把它们想象成网格的列或行。 下面是第二行和第三行网格线之间的网格轨道。</p>
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/44840078.jpg"></p>
      <h3 id="grid-cell">Grid Cell</h3>
      <p>两个相邻的行和两个相邻的列网格线之间的空间。它是网格的一个“单元”。 下面是行网格线1和2之间以及列网格线2和3的网格单元。</p>
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/38456584.jpg"></p>
      <h3 id="grid-area">Grid Area</h3>
      <p>四个网格线包围的总空间。 网格区域可以由任意数量的网格单元组成。 下面是行网格线1和3以及列网格线1和3之间的网格区域。</p>
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/38612829.jpg"></p>
  ...
  <span class="hljs-attribute">grid-template-rows</span>: <span class="hljs-number">25%</span> <span
      ...
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/55281623.jpg"></p>
  ...
  <span class="hljs-attribute">grid-template-rows</span>: [row1-start] <span
      ...
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/1314820.jpg"></p>
...
<span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-template-areas</span>:
    ...
    <span class="hljs-string">"footer footer footer footer"</span>;
      ...
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/45883436.jpg"></p>
  ...
  <span class="hljs-attribute">grid-row-gap</span>: <span class="hljs-number">15px</span>;
      ...
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/406531.jpg"></p>
  ...
  <span class="hljs-attribute">justify-items</span>: start;
      ...
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/81852061.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span>{
  <span class="hljs-attribute">justify-items</span>: end;
}
</code></pre>
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/57749032.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: center;
}
</code></pre>
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/73568687.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: stretch;
}
</code></pre>
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/81147184.jpg"></p>
  ...
  <span class="hljs-attribute">align-items</span>: start;
      ...
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/31201904.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: end;
}
</code></pre>
      <p><img alt="" src="https://cloud.hunger-valley.com/18-1-11/37389909.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: center;
}
</code></pre>
      <p><img alt="Example of align-items set to center" src="https://cloud.hunger-valley.com/18-1-11/64308393.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: stretch;
}
</code></pre>
      <p><img alt="Example of align-items set to stretch" src="https://cloud.hunger-valley.com/18-1-11/33767654.jpg">
      </p>
  ...
  <span class="hljs-attribute">justify-content</span>: start;
      ...
      <p><img alt="Example of justify-content set to start" src="https://cloud.hunger-valley.com/18-1-18/16621438.jpg">
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: end;
}
</code></pre>
      <p><img alt="Example of justify-content set to end" src="https://cloud.hunger-valley.com/18-1-11/46252522.jpg">
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: center;
}
</code></pre>
      <p><img alt="Example of justify-content set to center" src="https://cloud.hunger-valley.com/18-1-11/31369605.jpg">
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: stretch;
}
</code></pre>
      <p><img alt="Example of justify-content set to stretch"
              src="https://cloud.hunger-valley.com/18-1-11/65452171.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: space-around;
}
</code></pre>
      <p><img alt="Example of justify-content set to space-around"
              src="https://cloud.hunger-valley.com/18-1-12/79036314.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: space-between;
}
</code></pre>
      <p><img alt="Example of justify-content set to space-between"
              src="https://cloud.hunger-valley.com/18-1-12/36148565.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: space-evenly;
}
</code></pre>
      <p><img alt="Example of justify-content set to space-evenly"
              src="https://cloud.hunger-valley.com/18-1-12/9095829.jpg"></p>
  ...
  <span class="hljs-attribute">align-content</span>: start;
      ...
      <p><img alt="Example of align-content set to start" src="https://cloud.hunger-valley.com/18-1-12/9095829.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: end;
}
</code></pre>
      <p><img alt="Example of align-content set to end" src="https://cloud.hunger-valley.com/18-1-12/15060507.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: center;
}
</code></pre>
      <p><img alt="Example of align-content set to center" src="https://cloud.hunger-valley.com/18-1-12/72396881.jpg">
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: stretch;
}
</code></pre>
      <p><img alt="Example of align-content set to stretch" src="https://cloud.hunger-valley.com/18-1-12/46794685.jpg">
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: space-around;
}
</code></pre>
      <p><img alt="Example of align-content set to space-around"
              src="https://cloud.hunger-valley.com/18-1-12/81192919.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: space-between;
}
</code></pre>
      <p><img alt="Example of align-content set to space-between"
              src="https://cloud.hunger-valley.com/18-1-12/27437729.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: space-evenly;
}
</code></pre>
      <p><img alt="Example of align-content set to space-evenly"
              src="https://cloud.hunger-valley.com/18-1-12/6825571.jpg"></p>
  ...
  <span class="hljs-attribute">grid-template-rows</span>: <span class="hljs-number">90px</span> <span
      ...
      <p><img alt="Example of 2 x 2 grid" src="https://cloud.hunger-valley.com/18-1-12/90644000.jpg"></p>
      <p>这里创建了一个 2x2的网格。</p>
...
<span class="hljs-selector-class">.item-b</span> {
  ...
  <span class="hljs-attribute">grid-row</span>: <span class="hljs-number">2</span> / <span class="hljs-number">3</span>;
      ...
      <p><img alt="Example of implicit tracks" src="https://cloud.hunger-valley.com/18-1-12/38445302.jpg"></p>
  ...
  <span class="hljs-attribute">grid-auto-columns</span>: <span class="hljs-number">60px</span>;
      ...
      <p><img alt="Example of implicit tracks" src="https://cloud.hunger-valley.com/18-1-12/33573866.jpg"></p>
...
<span class="hljs-selector-class">.item-e</span> {
  ...
  <span class="hljs-attribute">grid-row</span>: <span class="hljs-number">1</span> / <span class="hljs-number">3</span>;
      ...
      <p><img alt="Example of grid-auto-flow set to row" src="https://cloud.hunger-valley.com/18-1-12/92242678.jpg"></p>
  ...
  <span class="hljs-attribute">grid-auto-flow</span>: column;
      ...
      <p><img alt="Example of grid-auto-flow set to column" src="https://cloud.hunger-valley.com/18-1-12/55339887.jpg">
      </p>
      <h3 id="grid">grid</h3>
      <p>
...
<span class="hljs-selector-class">.container</span> {
  ...
  grid-row-end: <span class="hljs-number">3</span>
      ...
      <p><img alt="Example of grid-row/column-start/end" src="https://cloud.hunger-valley.com/18-1-12/8301648.jpg"></p>
  ...
  grid-row-end: span <span class="hljs-number">2</span>
      ...
      <p><img alt="Example of grid-row/column-start/end" src="https://cloud.hunger-valley.com/18-1-12/35742447.jpg"></p>
  ...
  <span class="hljs-attribute">grid-row</span>: third-line / <span class="hljs-number">4</span>;
      ...
      <p><img alt="Example of grid-column/grid-row" src="https://cloud.hunger-valley.com/18-1-12/95036015.jpg"></p>
  ...
  <span class="hljs-attribute">grid-area</span>: <span class="hljs-number">1</span> / col4-start / last-line / <span
      ...
      <p><img alt="Example of grid-area" src="https://cloud.hunger-valley.com/18-1-12/37070111.jpg"></p>
  ...
  <span class="hljs-attribute">justify-self</span>: start;
      ...
      <p><img alt="Example of justify-self set to start" src="https://cloud.hunger-valley.com/18-1-12/53670315.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">justify-self</span>: end;
}
</code></pre>
      <p><img alt="Example of justify-self set to end" src="https://cloud.hunger-valley.com/18-1-12/15608697.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">justify-self</span>: center;
}
</code></pre>
      <p><img alt="Example of justify-self set to center" src="https://cloud.hunger-valley.com/18-1-12/42777942.jpg">
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">justify-self</span>: stretch;
}
</code></pre>
      <p><img alt="Example of justify-self set to stretch" src="https://cloud.hunger-valley.com/18-1-12/42754838.jpg">
      </p>
  ...
  <span class="hljs-attribute">align-self</span>: start;
      ...
      <p><img alt="Example of align-self set to start" src="https://cloud.hunger-valley.com/18-1-12/67517511.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">align-self</span>: end;
}
</code></pre>
      <p><img alt="Example of align-self set to end" src="https://cloud.hunger-valley.com/18-1-12/9140938.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">align-self</span>: center;
}
</code></pre>
      <p><img alt="Example of align-self set to center" src="https://cloud.hunger-valley.com/18-1-12/38240821.jpg"></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">align-self</span>: stretch;
}
</code></pre>
      <p><img alt="Example of align-self set to stretch" src="https://cloud.hunger-valley.com/18-1-12/84502177.jpg"></p>
